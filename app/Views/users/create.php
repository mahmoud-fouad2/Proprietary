...
<div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
  <div class="text-muted">إنشاء حساب جديد مع صلاحيات مخصصة.</div>
  ...
  <div class="card">
    <div class="card-body">
      <form method="post" action="<?= Http::e(Http::url('/users/create')) ?>" data-loading>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="text-muted small">يمكنك إخفاء أي تاب من القائمة حتى لو كانت صلاحية المستخدم تسمح به. (الأدمن مستثنى ويظهر له كل شيء).</div>
            </div>
            <div class="card-body">
